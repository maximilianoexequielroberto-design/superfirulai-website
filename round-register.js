...
function injectStyles() {
  ...
  style.textContent = `
    .sf-round-form{display:grid;gap:10px;position:relative;z-index:1}
     .sf-checkout-cluster{display:grid;gap:7px;padding:11px;border-radius:22px;background:linear-gradient(180deg,rgba(255,255,255,.028),rgba(255,255,255,.018));border:1px solid rgba(255,255,255,.07)}
    ...
    .sf-wallet-flow{display:grid;gap:9px;padding:12px;border-radius:20px;background:linear-gradient(180deg,rgba(255,255,255,.04),rgba(255,255,255,.02));border:1px solid rgba(255,255,255,.08)}
    ...
    .sf-open-phantom.show{display:inline-flex}
    .sf-price-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:9px;padding:12px;border-radius:20px;background:linear-gradient(180deg,rgba(255,255,255,.04),rgba(255,255,255,.02));border:1px solid rgba(255,255,255,.08)}
    ...
    .sf-steps{display:grid;gap:10px;padding:13px;border-radius:20px;background:linear-gradient(180deg,rgba(255,214,101,.08),rgba(24,163,255,.06));border:1px solid rgba(255,255,255,.10)}
    .sf-steps-compact{margin-top:2px}
    .sf-steps-head{display:flex;justify-content:space-between;align-items:flex-start;gap:12px}
    .sf-steps-head strong{display:block;color:#fff;font-size:17px;line-height:1.08}
    .sf-steps-head span{display:block;margin-top:5px;color:#b9cdf5;font-size:12px;line-height:1.45;max-width:58ch}
    ...
    .sf-step{position:relative;min-height:98px;padding:12px 12px 12px 14px;border-radius:17px;background:rgba(255,255,255,.035);border:1px solid rgba(255,255,255,.08);overflow:hidden}
    ...
    .sf-step span{display:block;margin-top:6px;color:#a9bee7;font-size:11px;line-height:1.4}
    ...
    @media (max-width:640px){.sf-row,.sf-row-tight,.sf-summary,.sf-action-grid,.sf-price-grid,.sf-receipt-hero,.sf-receipt-grid,.sf-history-summary,.sf-history-grid{grid-template-columns:1fr}.sf-row,.sf-row-tight,.sf-price-grid,.sf-summary,.sf-checkout-cluster,.sf-wallet-flow{padding:12px;border-radius:18px}.sf-checkout-cluster{gap:7px}.sf-receipt-overlay{padding:14px}.sf-receipt-card{padding:20px}.sf-receipt-top{align-items:flex-start}.sf-receipt-actions{flex-direction:column}.sf-receipt-btn{width:100%}.sf-steps{padding:12px;gap:9px}.sf-steps-head{flex-direction:column;gap:8px}.sf-steps-head strong{font-size:16px}.sf-steps-head span{font-size:12px;line-height:1.35}.sf-steps-kicker{padding:7px 10px;font-size:10px}.sf-steps-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.sf-step{min-height:88px;padding:11px 11px 11px 13px;border-radius:16px}.sf-step-num{width:25px;height:25px;font-size:12px}.sf-step strong{margin-top:7px;font-size:12.5px}.sf-step span{margin-top:5px;font-size:10.5px;line-height:1.32}.sf-step:last-child{grid-column:1/-1}.sf-trust-bar{grid-template-columns:1fr}}
  `;
